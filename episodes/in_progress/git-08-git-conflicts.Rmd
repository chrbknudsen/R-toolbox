...
toes.  This will even happen if you work alone: if we are working on
a piece of software on two different computers, we could make
different changes to each copy. This is to be expected, and version control 
helps us manage these conflicts by giving us tools to handle overlapping changes.
