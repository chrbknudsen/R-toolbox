...
Inter-Rater Reliability. That is our example. To what degree do two "raters" agree
...
Cohen's Kappa er en statistisk måde at måle overensstemmelse mellem to ratere, der klassificerer de samme objekter. Det bruges ofte til at vurdere pålideligheden af klassifikationer eller kategoriseringer, især i kontekster, hvor der er behov for at måle inter-rater reliability (overensstemmelse mellem forskellige ratere) eller intra-rater reliability (overensstemmelse for den samme rater over tid).

Her er nogle af de primære anvendelser af Cohen's Kappa:



Cohen's Kappa tager højde for tilfældig overensstemmelse, hvilket gør det til et mere robust mål end blot procentdelen af overensstemmelse. Det giver en værdi mellem -1 og 1, hvor 1 indikerer perfekt overensstemmelse, 0 indikerer ingen overensstemmelse ud over tilfældighed, og negative værdier indikerer mindre overensstemmelse end forventet ved tilfældighed.
