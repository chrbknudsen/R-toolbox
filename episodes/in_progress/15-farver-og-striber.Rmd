...
Different types of colourblindness exists, and the package give us four different plots,
one for each type of colourblindness_
...
being art, it is a good idea to take colourblindness into consideration. Not only
to help colour blind people, but also because the choice we make to do that, also makes
it easier for people with normal colour vision, to spot the differences and trends we
want to illustrate. 
